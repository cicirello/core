...
public final class ArrayFiller {
   ...
   *
   * @param n The length of the array.
   * @param offset The amount to offset each integer by, i.e., the value of the first int in the
   *     sequence.
   * @return The newly created array.
   */
  ...
  /**
   * Creates an array and fills it with the integers: n-1, n-1, ..., 1, 0, where n is the length of
   * the array.
   *
   * @param n The length of the array.
   * @return The newly created array.
  ...
  /**
   * Creates an array and fills it with the integers: x+n-1, x+n-1, ..., x+1, x, where n is the
   * length of the array.
   *
   * @param n The length of the array.
   * @param offset The amount to offset each integer by, i.e., the value of the last int in the
   *     sequence.
   * @return The newly created array.
   */
  ...
  /**
   * Fills an existing array with integers: x+n-1, x+n-2, ..., x+1, x, where n is the length of the
   * array
   *
   * @param array The array to fill.
   * @param offset The amount to offset each integer by, i.e., the value of the last int in the
