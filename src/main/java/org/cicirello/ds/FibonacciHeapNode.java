...
final class FibonacciHeapNode<E> {
	...
	private FibonacciHeapNode<E> copyList(FibonacciHeapNode<E> x, FibonacciHeapNode<E> p) {
		...
		for (FibonacciHeapNode<E> next = x.right; next != x; next = next.right, rightOf = rightOf.right) {
	...
	static final class Consolidator<E2> {
		...
		private final AbstractFibonacciHeap.PriorityComparator compare;
		
		Consolidator(AbstractFibonacciHeap.PriorityComparator compare) {
