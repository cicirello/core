 ...
 * used to create the IntFibonacciHeapDouble. Methods named <code>createMinHeap</code> produce
 ...
 * methods. In this example an IntFibonacciHeapDouble with an element domain of [0,100)
 * is created:</p>
 * <pre><code>
 * IntFibonacciHeapDouble&lt;String&gt; pq = IntFibonacciHeapDouble.createMinHeap(100);
 * </code></pre>
 * <p>In the above example, the element domain is [0,100) and the IntFibonacciHeapDouble
 * is initially empty.</p>
 *
 * <p><b>Purpose:</b> The purpose of such an IntFibonacciHeapDouble is to support
 ...
 */
public class IntFibonacciHeapDouble implements IntPriorityQueueDouble, Copyable<IntFibonacciHeapDouble> {
