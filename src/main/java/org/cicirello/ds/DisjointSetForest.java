 ...
 * objects in the sets are of a class that has appropriately implemented the {@link Object#equals}
 * and {@link Object#hashCode} methods. If you rely on the default implementations of those methods
 * from the {@link Object} class, then the disjoint set forest will treat two different objects
 ...
 * Forests are described by Cormen, Leiserson, Rivest, and Stein describe in <i>Introduction to
...
public final class DisjointSetForest<T> {
  ...
  public int findSet(T element) {
    ...
    if (node == null) {
      throw new IllegalArgumentException(
          "Element not in disjoint set forest: " + element.toString());
    }
   ...
   *
   * @param element The new element to add to the disjoint set forest, which must not already exist
