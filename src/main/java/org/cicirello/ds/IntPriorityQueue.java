 ...
 *
 * <p>For a more general purpose priority queue, see the {@link PriorityQueue} interface and the
...
public interface IntPriorityQueue {
  ...
  /**
   * Changes the priority of an element if the element is present in the IntPriorityQueue, and
   * otherwise adds the (element, priority) pair to the IntPriorityQueue.
   *
   ...
   * @return true if and only if the IntPriorityQueue changed as a consequence of this method call.
   */
   ...
   * IntPriorityQueue. For a min-heap, demotion means increasing the element's priority, while for a
   * max-heap, demotion means decreasing its priority. If the element is not in the
   * IntPriorityQueue, or if its new priority is not a demotion, then this method does nothing.
   *
   * @param element The element whose priority is to change.
   * @param priority Its new priority.
   * @throws IndexOutOfBoundsException if element is negative, or if element is greater than or
  ...
  /**
   * Returns the domain of this IntPriorityQueue. Note that the domain is not the same thing as the
   * size. The domain defines the elements that are allowed in the IntPriorityQueue, whether or not
   * they actually appear within it.
   *
  ...
  /**
   * Adds an (element, priority) pair to the IntPriorityQueue with a specified priority, provided
   * the element is not already in the IntPriorityQueue.
   *
   * @param element The element.
   * @param priority The priority of the element.
   * @return true if the (element, priority) pair was added, and false if the IntPriorityQueue
  ...
  /**
   * Gets the priority of the next element in priority order in the IntPriorityQueue. Behavior is
  ...
  /**
   * Gets the current priority of a specified element in the IntPriorityQueue. Behavior is undefined
   * if the IntPriorityQueue doesn't contain the element.
   *
  ...
  /**
   * Gets and removes the next element in priority order from this IntPriorityQueue. Behavior is
   * undefined if it is empty.
   *
   * @return the next element in priority order.
   */
   ...
   * IntPriorityQueue with a specified priority, provided the element is not already in the
   * IntPriorityQueue. Unlike the {@link #offer} method, this method does not provide an explicit
   * confirmation of success. If such confirmation is required, then you should instead directly use
   * a combination of {@link #poll} and {@link #offer}.
   *
   ...
   *     equal to the domain n.
   */
  default int pollThenOffer(int element, int priority) {
    int e = poll();
   ...
   * IntPriorityQueue. For a min-heap, promotion means decreasing the element's priority, while for
   * a max-heap, promotion means increasing its priority. If the element is not in the
   * IntPriorityQueue, or if its new priority is not a promotion, then this method does nothing.
   *
   * @param element The element whose priority is to change.
   * @param priority Its new priority.
   * @throws IndexOutOfBoundsException if element is negative, or if element is greater than or
  ...
  /**
   * Gets the current size of the IntPriorityQueue, which is the number of (element, priority) pairs
   * that it contains.
   *
