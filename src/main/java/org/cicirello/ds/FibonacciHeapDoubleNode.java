...
/**
 * Internal package access class for representing nodes in a fibonacci heap with priorityy of type
 * double.
 *
...
final class FibonacciHeapDoubleNode<E> {
  ...
  private FibonacciHeapDoubleNode(
      FibonacciHeapDoubleNode<E> other, FibonacciHeapDoubleNode<E> toTheLeft) {
    this(other);
    left = toTheLeft;
  }
  ...
  private FibonacciHeapDoubleNode<E> copyList(
      FibonacciHeapDoubleNode<E> x, FibonacciHeapDoubleNode<E> p) {
    ...
    for (FibonacciHeapDoubleNode<E> next = x.right;
        next != x;
  ...
  static final class Consolidator<E2> {
    ...
    Consolidator(DoublePrioritizer compare) {
