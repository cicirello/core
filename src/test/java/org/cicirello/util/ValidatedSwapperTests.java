...
/** Test cases for the ValidatedSwapper class. */
public class ValidatedSwapperTests {

  private final Swapper swapper;

  public ValidatedSwapperTests() {
    swapper = new Swapper();
  }
  ...
  private final class Swapper {
    ...
    private void swap(byte[] array, int i, int j) {
      ValidatedSwapper.swap(array, i, j);
    }
    ...
    private <T> void swap(List<T> list, int i, int j) {
      ValidatedSwapper.swap(list, i, j);
    }
  }
}
