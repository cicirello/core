...
public class DoubleListTests {
  ...
  public void testEmptyList() {
    ...
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> new DoubleList(0));
  }

  @Test
  public void testFromArray() {
    double[][] cases = {{100}, {100, 101}, {100, 101, 102}};
    ...
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> new DoubleList(new double[0]));
  }
  ...
  public void testIndexOf() {
    double[][] testCases = {{100}, {100, 101, 100}, {100, 101, 102, 101, 100}};
  ...
  public void testEqualsAndHashCode() {
    double[][] testCases = {{100}, {100, 101}, {100, 101, 102}};
