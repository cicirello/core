...
/**
 * Test cases for SimpleBinaryHeapDouble for max heap cases: constructor with initial capacity.
 */
public class SimpleBinaryCapacityMaxHeapDoubleTests extends SharedTestHelpersMaxHeapsDouble {
	
	public SimpleBinaryCapacityMaxHeapDoubleTests() {
		super(() -> SimpleBinaryHeapDouble.createMaxHeap(8), SimpleBinaryHeapDouble::createMaxHeap);
	}
