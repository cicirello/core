...
public class BinaryHeapTests extends SharedTestCommonHelpersHeaps {
  ...
  public void testMerge() {
    ...
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> pq1.merge(BinaryHeap.createMaxHeap()));
  }
  ...
  public void testExceptionsCapacityZero() {
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> BinaryHeap.createMinHeap(0));
    thrown = assertThrows(IllegalArgumentException.class, () -> BinaryHeap.createMaxHeap(0));
  }
}
