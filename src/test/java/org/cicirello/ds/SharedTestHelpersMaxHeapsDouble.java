 ...
 * specifically for the max heap cases. Note that the SharedTestHelpersMinHeapsDouble for min heaps
...
public abstract class SharedTestHelpersMaxHeapsDouble extends SharedTestHelpersHeapsDouble {
	...
	private final Function<Collection<PriorityQueueNode.Double<String>>, PriorityQueueDouble<String>> fromListFactory;
	
	SharedTestHelpersMaxHeapsDouble(Supplier<PriorityQueueDouble<String>> factory, Function<Collection<PriorityQueueNode.Double<String>>, PriorityQueueDouble<String>> fromListFactory) {
		super(false);
	...
	final void defaultMaxHeap() {
		...
		assertNull(pq.peek());
		assertEquals(Double.NEGATIVE_INFINITY, pq.peekPriority());
		for (int i = 0; i < n; i++) {
	...
	final void listEmptyMaxHeap() {
		PriorityQueueDouble<String> pq = fromListFactory.apply(new ArrayList<PriorityQueueNode.Double<String>>());
		assertEquals(0, pq.size());
		assertTrue(pq.isEmpty());
	}
