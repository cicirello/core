...
public class SimpleBinaryHeapTests extends SharedTestCommonHelpersHeaps {
  ...
  public void testMerge() {
    ...
    IllegalArgumentException thrown =
        assertThrows(
            IllegalArgumentException.class, () -> pq1.merge(SimpleBinaryHeap.createMaxHeap()));
  }
  ...
  public void testExceptionsCapacityZero() {
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> SimpleBinaryHeap.createMinHeap(0));
    thrown = assertThrows(IllegalArgumentException.class, () -> SimpleBinaryHeap.createMaxHeap(0));
  }
}
