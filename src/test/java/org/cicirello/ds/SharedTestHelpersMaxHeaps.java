 ...
 * includes more extensive tests. This class essentially validates that max heap order is used.
 * Other functionality doesn't need additional testing in both min and max cases.
 */
public abstract class SharedTestHelpersMaxHeaps extends SharedTestHelpersHeaps {
  ...
  private final Function<Collection<PriorityQueueNode.Integer<String>>, PriorityQueue<String>>
      fromListFactory;

  SharedTestHelpersMaxHeaps(
      Supplier<PriorityQueue<String>> factory,
      Function<Collection<PriorityQueueNode.Integer<String>>, PriorityQueue<String>>
          fromListFactory) {
    super(false);
  ...
  final void removeViaPairMaxHeap() {
    ...
    for (int i = 0; i < n; i++) {
      PriorityQueue<String> pq = factory.get();
      populate(pq, elements, priorities, n);
      PriorityQueueNode.Integer<String> pair =
          new PriorityQueueNode.Integer<String>(elements[i], priorities[i]);
  ...
  final void removeSamePriorityViaPairMaxHeap() {
    ...
    for (int i = 0; i < n; i++) {
      ...
      PriorityQueueNode.Integer<String> pair =
          new PriorityQueueNode.Integer<String>(elements[i], 42);
      assertTrue(pq.remove(pair));
      assertFalse(pq.contains(pair));
      assertEquals(n - 1, pq.size());
      assertFalse(pq.remove(pair));
  ...
  final void removePercolationViaPairMaxHeap() {
    ...
    populate(pq, elements, p, n);
    PriorityQueueNode.Integer<String> pair =
        new PriorityQueueNode.Integer<String>(elements[3], p[3]);
    assertTrue(pq.remove(pair));
    int[] expectedIndexOrder = {0, 2, 6, 1, 4, 5};
    for (int i = 0; i < expectedIndexOrder.length; i++) {
      assertEquals(elements[expectedIndexOrder[i]], pq.pollElement());
  ...
  final void listMaxHeap() {
    ...
    final ArrayList<PriorityQueueNode.Integer<String>> list2 =
        new ArrayList<PriorityQueueNode.Integer<String>>();
    list2.add(pairs[0]);
    list2.add(pairs[0]);
  ...
  final void listEmptyExceptionMaxHeap() {
    IllegalArgumentException thrown =
        assertThrows(
  ...
  final void listReverseDuplicatesAllowedMaxHeap() {
    int n = 31;
    String[] elements = createStringsRev(n);
    int[] priorities = createPriorities(elements);
    PriorityQueueNode.Integer<String>[] pairs = createPairs(elements, priorities);
  ...
  final void listArbitraryMaxHeap() {
    int n = 31;
    String[] elements = createStringsArbitrary(n);
    int[] priorities = createPriorities(elements);
    PriorityQueueNode.Integer<String>[] pairs = createPairs(elements, priorities);
  ...
  final void listArbitraryDuplicatesAllowedMaxHeap() {
    int n = 31;
    String[] elements = createStringsArbitrary(n);
    int[] priorities = createPriorities(elements);
    PriorityQueueNode.Integer<String>[] pairs = createPairs(elements, priorities);
  ...
  final void offerSeparateMaxHeap() {
    int n = 31;
    String[] elements = createStringsMaxCase(n);
    int[] priorities = createPriorities(elements);
    PriorityQueueNode.Integer<String>[] pairs = createPairs(elements, priorities);
  ...
  final void offerSeparateDuplicatesAllowedMaxHeap() {
    int n = 31;
    String[] elements = createStringsMaxCase(n);
    int[] priorities = createPriorities(elements);
    PriorityQueueNode.Integer<String>[] pairs = createPairs(elements, priorities);
  ...
  final void offerSeparateReverseMaxHeap() {
    int n = 31;
    String[] elements = createStringsRev(n);
    int[] priorities = createPriorities(elements);
    PriorityQueueNode.Integer<String>[] pairs = createPairs(elements, priorities);
  ...
  final void offerSeparateReverseDuplicatesAllowedMaxHeap() {
    int n = 31;
    String[] elements = createStringsRev(n);
    int[] priorities = createPriorities(elements);
    PriorityQueueNode.Integer<String>[] pairs = createPairs(elements, priorities);
  ...
  final void offerSeparateArbitraryMaxHeap() {
    int n = 31;
    String[] elements = createStringsArbitrary(n);
    int[] priorities = createPriorities(elements);
    PriorityQueueNode.Integer<String>[] pairs = createPairs(elements, priorities);
  ...
  final void offerSeparateArbitraryDuplicatesAllowedMaxHeap() {
    int n = 31;
    String[] elements = createStringsArbitrary(n);
    int[] priorities = createPriorities(elements);
    PriorityQueueNode.Integer<String>[] pairs = createPairs(elements, priorities);
  ...
  final void addSeparateDuplicatesAllowedMaxHeap() {
    int n = 31;
    String[] elements = createStringsMaxCase(n);
    int[] priorities = createPriorities(elements);
    PriorityQueueNode.Integer<String>[] pairs = createPairs(elements, priorities);
