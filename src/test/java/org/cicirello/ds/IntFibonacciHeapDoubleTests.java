 ...
 */
public class IntFibonacciHeapDoubleTests extends SharedTestHelpersIntHeapDouble {
	
	public IntFibonacciHeapDoubleTests() {
		super(IntFibonacciHeapDouble::createMinHeap, IntFibonacciHeapDouble::createMaxHeap);
	}
