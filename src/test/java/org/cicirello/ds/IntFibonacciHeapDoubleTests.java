...
/**
 * JUnit tests for the IntFibonacciHeapDouble class.
 */
public class IntFibonacciHeapDoubleTests {
	
	// Tests not specific to min heap vs max heap
	
	@Test
	public void testCopy() {
		IntFibonacciHeapDouble min0 = IntFibonacciHeapDouble.createMinHeap(10);
		IntFibonacciHeapDouble max0 = IntFibonacciHeapDouble.createMaxHeap(10);
		IntFibonacciHeapDouble min1 = IntFibonacciHeapDouble.createMinHeap(10);
		for (int i = 0; i < 5; i++) {
			min1.offer(i, 42*i);
		}
		IntFibonacciHeapDouble min2 = IntFibonacciHeapDouble.createMinHeap(10);
		for (int i = 0; i < 5; i++) {
			min2.offer(i, 43*i);
		}
		IntFibonacciHeapDouble max1 = IntFibonacciHeapDouble.createMaxHeap(10);
		for (int i = 0; i < 5; i++) {
			max1.offer(i, 42*i);
		}
		IntFibonacciHeapDouble max2 = IntFibonacciHeapDouble.createMaxHeap(10);
		for (int i = 0; i < 5; i++) {
			max2.offer(i, 43*i);
		}
		IntFibonacciHeapDouble minMultiLevel = IntFibonacciHeapDouble.createMinHeap(24);
		IntFibonacciHeapDouble maxMultiLevel = IntFibonacciHeapDouble.createMaxHeap(24);
		...
		IntFibonacciHeapDouble minMultiLevelCopy = minMultiLevel.copy();
		IntFibonacciHeapDouble maxMultiLevelCopy = maxMultiLevel.copy();
		double lastMin = -1000;
		double lastMax = 1000;
		for (int i = 0; i < 20; i++) {
		...
		IntFibonacciHeapDouble minCopy0 = min0.copy();
		IntFibonacciHeapDouble minCopy1 = min1.copy();
		IntFibonacciHeapDouble minCopy2 = min2.copy();
		IntFibonacciHeapDouble maxCopy0 = max0.copy();
		IntFibonacciHeapDouble maxCopy1 = max1.copy();
		IntFibonacciHeapDouble maxCopy2 = max2.copy();
	...
	public void testCreateMinHeap() {
		...
		IllegalArgumentException thrown = assertThrows( 
			...
			() -> IntFibonacciHeapDouble.createMinHeap(0)
		);
	}
	
	@Test
	public void testClearMinHeap() {
		IntFibonacciHeapDouble pq = IntFibonacciHeapDouble.createMinHeap(10);
		for (int i = 0; i < 5; i++) {
			pq.offer(i, 42*i);
		}
	...
	public void testCreateMaxHeap() {
		...
		IllegalArgumentException thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> IntFibonacciHeapDouble.createMaxHeap(0)
		);
	}
	
	@Test
	public void testClearMaxHeap() {
		IntFibonacciHeapDouble pq = IntFibonacciHeapDouble.createMaxHeap(10);
		for (int i = 0; i < 5; i++) {
			pq.offer(i, 42*i);
		}
		assertEquals(5, pq.size());
