...
/**
 * Test cases for BinaryHeapDouble for max heap cases.
 */
public class BinaryMaxHeapDoubleTests extends SharedTestHelpersMaxHeapsDouble {
	
	public BinaryMaxHeapDoubleTests() {
		super(BinaryHeapDouble::createMaxHeap, BinaryHeapDouble::createMaxHeap);
	}
