...
public class BinaryHeapDoubleTests extends SharedTestCommonHelpersHeapsDouble {
  ...
  public void testMerge() {
    ...
    IllegalArgumentException thrown =
        assertThrows(
            IllegalArgumentException.class, () -> pq1.merge(BinaryHeapDouble.createMaxHeap()));
  }
  ...
  public void testAddAllCapacity() {
    ...
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> pq.addAll(list));
  }
  ...
  public void testExceptionsCapacityZero() {
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> BinaryHeapDouble.createMinHeap(0));
    thrown = assertThrows(IllegalArgumentException.class, () -> BinaryHeapDouble.createMaxHeap(0));
  }
}
