...
public class FibonacciHeapDoubleTests extends SharedTestCommonHelpersHeapsDouble {
	...
	public FibonacciHeapDoubleTests() {
		super(FibonacciHeapDouble::createMinHeap, FibonacciHeapDouble::createMaxHeap, FibonacciHeapDouble::createMinHeap, FibonacciHeapDouble::createMaxHeap);
	}
	...
	public void testMerge() {
		...
		for (int i = 0; i < 2*n; i+=2) {
			...
			priorities1[i/2] = i;
			priorities2[i/2] = i+1;
			PriorityQueueNode.Double<String> node1 = new PriorityQueueNode.Double<String>(elements1[i/2], priorities1[i/2]);
			PriorityQueueNode.Double<String> node2 = new PriorityQueueNode.Double<String>(elements2[i/2], priorities2[i/2]);
			list1.add(node1);
			list2.add(node2);
			pq1.offer(node1);
			pq2.offer(node2);
		...
		IllegalArgumentException thrown = assertThrows( 
			...
			() -> pq1.merge(FibonacciHeapDouble.createMaxHeap())
		);
	}
