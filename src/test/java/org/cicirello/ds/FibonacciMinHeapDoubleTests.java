...
/**
 * Test cases for FibonacciHeapDouble for min heap cases.
 */
public class FibonacciMinHeapDoubleTests extends SharedTestHelpersMinHeapsDouble {
	
	public FibonacciMinHeapDoubleTests() {
		super(FibonacciHeapDouble::createMinHeap, FibonacciHeapDouble::createMinHeap);
	}
