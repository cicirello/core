...
/**
 * Test cases for BinaryHeap for min heap cases: constructor with initial capacity.
 */
public class BinaryCapacityMinHeapTests extends SharedTestHelpersMinHeaps {
	
	public BinaryCapacityMinHeapTests() {
		super(() -> BinaryHeap.createMinHeap(8), BinaryHeap::createMinHeap);
	}
