...
public class IntBinaryHeapDoubleTests extends SharedTestHelpersIntHeapDouble {

  public IntBinaryHeapDoubleTests() {
    super(IntBinaryHeapDouble::createMinHeap, IntBinaryHeapDouble::createMaxHeap);
  }
