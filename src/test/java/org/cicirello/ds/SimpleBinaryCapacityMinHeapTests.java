...
/** Test cases for SimpleBinaryHeap for min heap cases: constructor with initial capacity. */
public class SimpleBinaryCapacityMinHeapTests extends SharedTestHelpersMinHeaps {

  public SimpleBinaryCapacityMinHeapTests() {
    super(() -> SimpleBinaryHeap.createMinHeap(8), SimpleBinaryHeap::createMinHeap);
  }
