...
/**
 * Test cases for SimpleBinaryHeap for max heap cases: constructor with initial capacity.
 */
public class SimpleBinaryCapacityMaxHeapTests extends SharedTestHelpersMaxHeaps {
	
	public SimpleBinaryCapacityMaxHeapTests() {
		super(() -> SimpleBinaryHeap.createMaxHeap(8), SimpleBinaryHeap::createMaxHeap);
	}
