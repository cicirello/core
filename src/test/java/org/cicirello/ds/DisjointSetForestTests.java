...
public class DisjointSetForestTests {
  ...
  public void testConstruction() {
    ...
    for (int n : N) {
      ...
      IllegalArgumentException thrown =
          assertThrows(IllegalArgumentException.class, () -> sets.findSet("hello"));

      if (n > 0) {
        thrown = assertThrows(IllegalArgumentException.class, () -> sets.makeSet("A"));
      }
    }
  }
  ...
  public void testUnionOneLevel() {
    for (int n = 2; n <= 16; n *= 2) {
      ...
      IllegalArgumentException thrown =
          assertThrows(IllegalArgumentException.class, () -> sets.union("A", "hello"));
    ...
    for (int n = 2; n <= 16; n *= 2) {
      ...
      IllegalArgumentException thrown =
          assertThrows(IllegalArgumentException.class, () -> sets.union("hello", "A"));
    }
  }
