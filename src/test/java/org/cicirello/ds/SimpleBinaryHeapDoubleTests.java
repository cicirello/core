...
public class SimpleBinaryHeapDoubleTests extends SharedTestCommonHelpersHeapsDouble {
  ...
  public void testExceptionsCapacityZero() {
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> SimpleBinaryHeapDouble.createMinHeap(0));
    thrown =
        assertThrows(IllegalArgumentException.class, () -> SimpleBinaryHeapDouble.createMaxHeap(0));
  }
}
