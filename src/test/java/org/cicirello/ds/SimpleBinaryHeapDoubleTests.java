 ...
 */
public class SimpleBinaryHeapDoubleTests extends SharedTestCommonHelpersHeapsDouble {
	
	public SimpleBinaryHeapDoubleTests() {
		super(SimpleBinaryHeapDouble::createMinHeap, SimpleBinaryHeapDouble::createMaxHeap, SimpleBinaryHeapDouble::createMinHeap, SimpleBinaryHeapDouble::createMaxHeap);
	}
	...
	public void testEqualsAndHashCode() {
		equalsAndHashCode(BinaryHeapDouble::createMinHeap);
	}
