...
public class IntBinaryHeapTests extends SharedTestHelpersIntHeap {

  public IntBinaryHeapTests() {
    super(IntBinaryHeap::createMinHeap, IntBinaryHeap::createMaxHeap);
  }
