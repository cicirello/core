...
/**
 * Test cases for SimpleBinaryHeapDouble for max heap cases.
 */
public class SimpleBinaryMaxHeapDoubleTests extends SharedTestHelpersMaxHeapsDouble {
	
	public SimpleBinaryMaxHeapDoubleTests() {
		super(SimpleBinaryHeapDouble::createMaxHeap, SimpleBinaryHeapDouble::createMaxHeap);
	}
