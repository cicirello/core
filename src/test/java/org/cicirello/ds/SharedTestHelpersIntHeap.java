...
/** Common testing code for classes that implement heaps of ints with int-valued priorities. */
public abstract class SharedTestHelpersIntHeap {
  ...
  SharedTestHelpersIntHeap(
      IntFunction<IntPriorityQueue> minHeapFactory, IntFunction<IntPriorityQueue> maxHeapFactory) {
