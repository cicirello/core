...
/**
 * Test cases for SimpleBinaryHeapDouble for min heap cases.
 */
public class SimpleBinaryMinHeapDoubleTests extends SharedTestHelpersMinHeapsDouble {
	
	public SimpleBinaryMinHeapDoubleTests() {
		super(SimpleBinaryHeapDouble::createMinHeap, SimpleBinaryHeapDouble::createMinHeap);
	}
