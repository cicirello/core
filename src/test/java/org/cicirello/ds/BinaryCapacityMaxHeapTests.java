...
/**
 * Test cases for BinaryHeap for max heap cases: constructor with initial capacity.
 */
public class BinaryCapacityMaxHeapTests extends SharedTestHelpersMaxHeaps {
	
	public BinaryCapacityMaxHeapTests() {
		super(() -> BinaryHeap.createMaxHeap(8), BinaryHeap::createMaxHeap);
	}
